...
\centering
    \begin{tabular}{|l|l|c|}
    \hline
    \multicolumn{1}{|l|}{\textbf{Lp.}} & \multicolumn{1}{l|}{\textbf{Parametr}} & \multicolumn{1}{c|}{\textbf{Wartośæ}} \\
    \hline
       1.   & Napięcie zasilania [V] & 12  \\
    \hline
       2.   &  Prędkośæ obrotowa [obr/min]& 200\\
    \hline
    ...
    \hline
       7.  & Rozdzielczośæ enkodera [imp/obr]   &  75 \\
    \hline
    \end{tabular}
  \label{silnik_skret}
\end{table}
